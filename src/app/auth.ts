    ...
    CredentialsProvider({
      ...
      authorize: async (credentials) => {
        try {
          ...
          if(isRegister){
            const register_response = await fetch("http://arfbackend-h3g2bdftbxdffqcy.westeurope-01.azurewebsites.net/auth/teacher/register", {
              method: "POST",
          ...
          if (teacher) {
            ...
            let backendResponse = await fetch("http://arfbackend-h3g2bdftbxdffqcy.westeurope-01.azurewebsites.net/auth/teacher/login", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
            ...
            let backendResponse = await fetch("http://arfbackend-h3g2bdftbxdffqcy.westeurope-01.azurewebsites.net/auth/institution_admin/login", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              body: JSON.stringify({ email, password }),
            });
